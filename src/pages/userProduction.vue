                ...
                <div style="width: 33%; height: 98%; margin: 1px 0 2px 0;">
                    ...
                    <div class="row justify-center">
                        ...
                        <q-select v-model="apitax" style="padding-top: 7px; width: 150px;" outlined :dense="dense"
                            transition-show="jump-up" transition-hide="jump-up" :options="options" options-value="VALUE" option-label="LABEL" />
                    </div>
                </div>
            </div>
            <div class="row" style="height: 60px; width: 60%; margin-left: auto; margin-right: auto;">
    ...
    <q-dialog v-model="promptnew" persistent>
        <q-card style="min-width: 500px">
            ...
            <q-card-section class="q-pa-md q-col-gutter-md">
                ...
                <q-select filled v-model="tax" :options="options" options-value="VALUE" option-label="LABEL"
                transition-show="jump-up" transition-hide="jump-up" :rules="taxRules"></q-select> 
            </q-card-section>
    ...
    setup() {
        ...
        const insertproduct = () => {
            if (isediting.value === -2) {
                ...
                rows[isediting.value].tax = tax.value.LABEL
                addnumber.value = ''
                addproductname.value = ''
                addprice.value = ''
                fromdate.value = ''
